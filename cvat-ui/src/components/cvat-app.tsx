...
import { TimeoutLogic } from './timeoutLogic/TimeoutLogic';
                ...
                <GlobalErrorBoundary>
                    <>
                        <Switch>
                            ...
                            { routesToRender }
                            <Redirect
                                //to={location.pathname.length > 1 ? `/auth/login?next=${location.pathname}` : '/auth/login'}     //Old
                                to={location.pathname.length > 1 ? '/auth/login' : '/auth/login'}                                 //New
                            />
                        </Switch>
                        <InvitationWatcher />
                    </>
